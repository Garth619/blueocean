...
<body id="<?php echo $page ?>" <?php body_class(); ?>>
			...
			<div style="clear:both"></div>
				...
				<img class="menu_header_pic" src="<?php the_field('new_lunch_image'); ?>"/>
					...
					<?php while(has_sub_field('from_the_kitchen')): ?>
								<li><span class="menu_item_title"><?php the_sub_field('menu_item_lunch2'); ?></span><span class="menu_item_price"><?php the_sub_field('menu_price_lunch2'); ?></span><span class="menu_description" style="clear:both"><?php the_sub_field('menu_description_lunch2'); ?></span></li>
    <?php endwhile; ?>
							</ul><!-- menu_list -->
					</div><!-- one_menu_col -->
					<?php endif; ?>
